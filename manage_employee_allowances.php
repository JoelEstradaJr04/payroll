        ...
        <div class="row form-group">
            <div class="col-md-5">
                ...
                <select id="allowance_id" class="borwser-default select2">
                    <option value=""></option>
                    <?php
                    $allowance_sql = "SELECT * FROM allowances ORDER BY allowance ASC"; // SQL Server query
                    ...
                    <?php endwhile;
                    sqlsrv_free_stmt($allowance_stmt); // Free statement resource
                    ?>
                </select>
            </div>
            <div class="col-md-3">
            ...
            $.ajax({
                ...
                success: function (resp) {
                    if (resp == 1) {
                        ...
                        console.error("Error saving allowance:", resp); // Log the error for debugging
                        alert_toast("Error saving allowance. Check console for details.", "danger"); // User-friendly alert
                    }
                }
            })
        })
