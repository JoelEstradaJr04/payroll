        ...
        <div class="row form-group">
            <div class="col-md-5">
                ...
                <select id="deduction_id" class="borwser-default select2">
                    <option value=""></option>
                    <?php
                    $deduction_sql = "SELECT * FROM deductions ORDER BY deduction ASC"; // SQL Server query
                    ...
                    <?php endwhile;
                    sqlsrv_free_stmt($deduction_stmt); // Free statement resource
                    ?>
                </select>
            </div>
            <div class="col-md-3">
    ...
    $(document).ready(function () {
        $('#employee-deduction').submit(function (e) {
            ...
            $.ajax({
                ...
                method: "POST",
                data: $(this).serialize(),
                error: err => console.log(err), // Log errors to console
                success: function (resp) {
                    if (resp == 1) {
                        ...
                        console.error("Error saving deduction:", resp); // Log the error for debugging
                        alert_toast("Error saving deduction. Check console for details.", "danger"); // User-friendly alert
                    }
                }
            })
        })
